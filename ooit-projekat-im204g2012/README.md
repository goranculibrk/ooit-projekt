...
# Vežba 2 #
1. Implementirati sledeæe metode u klasi `Tacka`
	1. `void pomeriNa (int novoX, int novoY)`
	2. `void pomeriZa (int poX, int poY)`
	3. `double udaljenost (Tacka t)`

2. Kreirati klasu `Linija`
	1. definisati varijable instance koje odgovaraju poèetnoj i krajnjoj taèki
...
1. Kreirati klasu `Pravougaonik` tako da varijable instance predstavljaju
	1. taèku gornjeg levog ugla pravougaonika
...
3. U klasi `Pravougaonik` implementirati metode koje vraæaju: 
